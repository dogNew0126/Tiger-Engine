...
namespace tiger {
	...
	void Scene3D::init() {
		...
		//add(new scene::SceneNode(glm::vec3(90.0f, 60.0f, 90.0f), glm::vec3(3.0f, 3.0f, 3.0f), glm::vec3(0.0f, 1.0f, 0.0f), 0, new tiger::graphics::Model("res/3D_Models/Crysis/nanosuit.obj"), nullptr, false));
		//add(new scene::SceneNode(glm::vec3(200.0f, 100.0f, 100.0f), glm::vec3(0.05f, 0.05f, 0.05f), glm::vec3(0.0f, 0.0f, 1.0f), glm::radians(0.0f), new tiger::graphics::Model("res/3D_Models/Sponza/sponza.obj"), nullptr, false));
		...
		for (int row = 0; row < nrRows; row++) {
			for (int col = 0; col < nrColumns; col++) {
				...
				add(new RenderableModel(glm::vec3((float)(col - (nrColumns / 2)) * spacing,
