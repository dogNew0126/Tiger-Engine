...
namespace tiger {
	...
	void Scene3D::init() {
		// Load models
		Add(new graphics::Renderable3D(glm::vec3(30.0f, -10.0f, 30.0f), glm::vec3(3.0f, 3.0f, 3.0f), glm::vec3(0.0f, 1.0f, 0.0f), .0f, new tiger::graphics::Model("res/3D_Models/Crysis/nanosuit.obj")));
		Add(new graphics::Renderable3D(glm::vec3(200.0f, 200.0f, 100.0f), glm::vec3(0.2f, 0.2f, 0.2f), glm::vec3(0.0f, 0.0f, 0.0f), 0, new tiger::graphics::Model("res/3D_Models/Sponza/sponza.obj")));
