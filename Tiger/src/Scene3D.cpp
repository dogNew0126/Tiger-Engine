...
namespace tiger {
	...
	Scene3D::Scene3D(graphics::FPSCamera* camera, graphics::Window* window)
		: terrainShader("src/shaders/basic.vert", "src/shaders/terrain.frag"), modelShader("src/shaders/basic.vert", "src/shaders/multipleLight.frag"), m_Camera(camera), m_Window(window), outlineShader("src/shaders/basic.vert", "src/shaders/basic.frag")
	{
	...
	void Scene3D::init() {
		...
		// Load models
		//Add(new graphics::Renderable3D(glm::vec3(30.0f, -10.0f, 30.0f), glm::vec3(0.2f, 0.2f, 0.2f), glm::vec3(0.0f, 1.0f, 0.0f), 0, new tiger::graphics::Model("res/3D_Models/Overwatch/Reaper/Reaper.obj")));
		//Add(new graphics::Renderable3D(glm::vec3(60.0f, -10.0f, 60.0f), glm::vec3(0.2f, 0.2f, 0.2f), glm::vec3(0.0f, 1.0f, 0.0f), 0, new tiger::graphics::Model("res/3D_Models/Overwatch/McCree/McCree.obj")));
		Add(new graphics::Renderable3D(glm::vec3(90.0f, -10.0f, 90.0f), glm::vec3(3.0f, 3.0f, 3.0f), glm::vec3(0.0f, 1.0f, 0.0f), 0, new tiger::graphics::Model("res/3D_Models/Crysis/nanosuit.obj"), true));
