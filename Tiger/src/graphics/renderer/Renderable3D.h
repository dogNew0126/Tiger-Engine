...
namespace tiger {
	namespace graphics {
		...
		public:
			Renderable3D(const glm::vec3& position, const glm::vec3& scale, const glm::vec3& rotationAxis, float radianRotation, Model* model, bool shouldOutline = false, bool transparent = false);
			~Renderable3D();
